...
func (es *EchoRouter) Attach(e *echo.Echo) {
...
func (es *EchoRouter) StateHandler() echo.HandlerFunc {
...
func (es *EchoRouter) OverviewHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
...
func (es *EchoRouter) TenantOverviewHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
...
func (es *EchoRouter) GetModuleHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		ref := c.Param("ref")
...
func (es *EchoRouter) WorkflowsHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		namespace := c.Param("namespace")
...
func (es *EchoRouter) ConnectionsHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		namespace := c.Param("namespace")
		version, err := strconv.Atoi(c.Param("version"))
...
func (es *EchoRouter) AuthenticationHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		namespace := c.Param("namespace")
		version, err := strconv.Atoi(c.Param("version"))
...
func (es *EchoRouter) CapabilitiesHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		namespace := c.Param("namespace")
		version, err := strconv.Atoi(c.Param("version"))
...
func (es *EchoRouter) FileHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
...
func (es *EchoRouter) QueriesHandler() echo.HandlerFunc {
	return func(c echo.Context) error {
		ident := c.Param("ident")
		namespace := c.Param("namespace")
		version, err := strconv.Atoi(c.Param("version"))
